    ...
    return (
        <div>
            <aside className="flex">
                <div className="flex flex-col items-center w-16 h-screen py-8 bg-white dark:bg-gray-900 dark:border-gray-700 hidden">
                ...
                <div className="h-screen px-5 py-5 overflow-y-auto bg-white border-l border-r sm:w-64 w-60 dark:bg-gray-900 dark:border-gray-700 hidden md:block">
                    <div className='flex items-center flex-col justify-center mb-5'>
                        ...
                        <div className="flex flex-col items-center mt-6 -mx-2">
                            <img className="object-cover w-24 h-24 mx-2 rounded-full" src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80" alt="avatar"/>
                                <h4 className="mx-2 mt-2 font-medium text-gray-800 dark:text-gray-200">Hanzal Salim</h4>
                                <p className="mx-2 mt-1 text-sm font-medium text-gray-600 dark:text-gray-400">hanzalsalim@example.com</p>
                        </div>
                    </div>
