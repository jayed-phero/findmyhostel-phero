        ...
        <div>
            <section className="bg-white dark:bg-gray-900">
                <div className="max-w-7xl px-6 py-12 mx-auto">
                    ...
                    <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2 items-start">
                        ...
                        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 ">
                            <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                                ...
                                <h2 className="mt-4 text-base font-medium text-gray-800 dark:text-white">Chat to reach</h2>
                                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Speak to our friendly team.</p>
                                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">hanzalsalim@gmail.com</p>
                            </div>
                            ...
                            <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                                ...
                                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Sat-Thu from 8am to 5pm.</p>
